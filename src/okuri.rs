...
pub fn okuri_key_to_suffixes(key: char) -> &'static [&'static str] {
    match key.to_ascii_lowercase() {
        ...
        'e' => &["え", "える", "う", "えた", "えて", "えば"], // 下一段/仮定・命令形/ワ行五段 (使え/教え/考え/答え, 使える/教える, 使う, 使えた, 使えて, 使えば)
        'o' => &["おう", "お", "う"], // 意志形/オ段 (使おう/思おう/買おう, 使う)
        'a' => &["わない", "わ", "う", "ない"], // 未然形・否定形 (使わない/思わない, 使う, 教えない)
        'i' => &["い", "う", "く", "け", "かった", "くて"], // 形容詞/連用形 (美しい/美しく/美しかった/美しくて, 使い/使う)
...
fn order_suffixes_for_stem(stem: &str, key: char, default_suffixes: &'static [&'static str]) -> &'static [&'static str] {
    ...
    match key.to_ascii_lowercase() {
        ...
        'e' => &["え", "える", "う", "えた", "えて"], // 使え/教え/考え (下一段名詞/命令), 使える/教える (下一段終止), 使う (五段終止)
        'o' => &["おう", "お", "う"], // 使おう/思おう
        'a' => &["わない", "わ", "う", "ない"], // 使わない/思わない
        'd' => &["で", "だ", "んだ", "んで"], // 読んだ/遊んだ
